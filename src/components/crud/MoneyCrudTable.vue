<template>
    <el-table :="$attrs" class="max-h-full" show-overflow-tooltip flexible
        ...
        <el-table-column v-if="moneyCrud.optShow.checkbox" :selectable="row => !moneyCrud.rowOptDisabled.checkbox(row)" type="selection" width="55" />
