<template>
    <PageWrapper>
        ...
        <MoneyRR :money-crud="moneyCrud">
            <el-input v-model="moneyCrud.query.tenantCode" placeholder="编码" class="md:!w-52"
                      @keyup.enter.native="moneyCrud.doQuery" />
            <el-input v-model="moneyCrud.query.tenantName" placeholder="名称" class="md:!w-52"
                      @keyup.enter.native="moneyCrud.doQuery" />
        </MoneyRR>
        <!-- 操作行 -->
...
import tenantApi from "@/api/module/tenant.js"
