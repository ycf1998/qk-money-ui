<template>
    <PageWrapper>
        ...
        <MoneyRR :money-crud="moneyCrud">
            <el-input v-model="moneyCrud.query.roleCode" placeholder="角色编码" class="md:!w-52"
                      @keyup.enter.native="moneyCrud.doQuery" />
            <el-input v-model.number="moneyCrud.query.name" placeholder="角色名称/描述" class="md:!w-52"
                      @keyup.enter.native="moneyCrud.doQuery" />
